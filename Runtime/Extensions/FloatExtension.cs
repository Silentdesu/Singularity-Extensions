namespace SingularityLab.Runtime.Extensions
{
    ...
    public static partial class FloatExtension
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool IsAlmostZero(this float value, float tolerance = .01f)
        {
            return value < tolerance && value > -tolerance;
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool AlmostEquals(this float valueA, float valueB, float tolerance = .01f)
        {
